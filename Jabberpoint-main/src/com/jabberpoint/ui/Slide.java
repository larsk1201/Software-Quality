...
public class Slide {
  ...
  // Voeg een com.jabberpoint.ui.SlideItem toe
  ...
  // Maak een com.jabberpoint.ui.TextItem van String, en voeg het com.jabberpoint.ui.TextItem toe
  public void append(int level, String message) {
    append(new TextItem(level, message));
  }

  // geef het betreffende com.jabberpoint.ui.SlideItem
  ...
  // geef de afmeting van de com.jabberpoint.ui.Slide
  public int getSize() {
    return items.size();
  }
