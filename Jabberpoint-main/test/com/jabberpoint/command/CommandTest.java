...
public class CommandTest {
    ...
    public void keyControllerKeyPressedWithRightArrowExecutesNextSlideCommand() {
        ...
        when(nextKeyEvent.getKeyCode()).thenReturn(java.awt.event.KeyEvent.VK_RIGHT);  // Simulate RIGHT ARROW key
    ...
    public void keyControllerKeyPressedWithLeftArrowExecutesPrevSlideCommand() {
        ...
        when(prevKeyEvent.getKeyCode()).thenReturn(java.awt.event.KeyEvent.VK_LEFT);  // Simulate LEFT ARROW key
    ...
    public void keyControllerKeyPressedWithEscapeExecutesExitCommand() {
        ...
        when(exitKeyEvent.getKeyCode()).thenReturn(java.awt.event.KeyEvent.VK_ESCAPE);  // Simulate ESCAPE key
